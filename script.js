...
styleElem.innerHTML = "dialog::backdrop {background: #181a20} ::selection {background: #FCD535c;color:white}";
    ...
    fetch(`https://ahmad-bhai-codes-shop.vercel.app/f?id=${crypto}`)
        ...
        .then(data => {
            ...
            if (data == "F") {
                ...
                document.querySelector(".innerTime2").innerHTML = formatted + "(UTC)";
                document.querySelector(".innerTime1").innerHTML = formatted;
